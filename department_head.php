        ...
        <!--Sidebar start here-->
          <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                <i class="fa-solid fa-user"></i>Department Head
            </div>
            <div class="list-group list-group-flush my-3 secondary-bg" style="height:100%;">
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="manage_request/view.php" target="ifr" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fas fa-tachometer-alt me-2"></i>Manage request
                </a>

                <a href="staffop/view.php" target="ifr" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fas fa-tachometer-alt me-2"></i>View Item
                </a>
                <a href="dep'top/view_disposal.php" target="ifr" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fas fa-tachometer-alt me-2"></i>Manage disposal
                </a>            
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i><?php echo $_SESSION['head'];?>
                            </a>
