<?php
 ...
 $search="new";
 $statement=$pdo->prepare("SELECT * FROM property WHERE property_status LIKE :new");
 $statement->bindValue(':new',"%$search%");
 $statement->execute();
            ...
            <div class="collapse navbar-collapse bg-gray" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   <li class="nav-item me-3">
                        <a class="nav-link  btn btn-outline-info active" href="new.php">New</a></a>
                    </li>
                    <li class="nav-item me-3">
