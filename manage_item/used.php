<?php
 ...
 $search="used";
 $statement=$pdo->prepare("SELECT * FROM property WHERE property_status LIKE :used");
 $statement->bindValue(':used',"%$search%");
 $statement->execute();
            ...
            <div class="collapse navbar-collapse bg-gray" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   <li class="nav-item me-3">
                    ...
                    <li class="nav-item me-3">
                        <a class="nav-link btn btn-outline-info active" aria-current="" href="used.php">Used</a>
                    </li>
                    <li class="nav-item">
