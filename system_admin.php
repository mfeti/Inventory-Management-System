<?php 
    session_start();
    if($_SERVER['REQUEST_METHOD']==='POST' and isset($_POST['logout']) and isset($_SESSION['admin'])){
        ...
        <!--Sidebar start here-->
          <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                <i class="fa-solid fa-user"></i>System Admin
            </div>
            <div class="list-group list-group-flush my-3 secondary-bg" style="height:100%;">
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="admin_crud/view.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold" target="ifr">
                    <i class="fas fa-tachometer-alt me-2"></i>Manage User Account 
                </a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i>System admin
                            </a>
